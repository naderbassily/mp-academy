...
<header class="c-header" aria-label="Website header">
  ...
  <div class="c-header__primary">
    ...
    <div class="c-header__group">
      ...
      <?php else : ?>
        <a class="c-button c-button--outline-white c-button--small" href="<?php echo esc_url(home_url('/logout')); ?>">Log out</a>
      <?php endif; ?>
    </div>
  </div>
  ...
  <div id="overlay-menu" class="c-header__overlay" aria-hidden="true" aria-modal="true">
    ...
    <div class="c-header__group">
      <?php if (!$is_logged_in) : ?>
        <a class="c-button c-button--blue c-button--small" href="<?php echo esc_url(wp_login_url()); ?>">Login</a>
        <a class="c-button c-button--outline-white c-button--small" href="<?php echo esc_url(wp_registration_url()); ?>">Register</a>
      <?php else : ?>
