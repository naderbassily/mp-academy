    ...
    <div class="u-wrap--content">
      ...
      <?php elseif ( ! $has_access ) : ?>
        ...
        if ( shortcode_exists('learndash_payment_buttons') ) {
          $enroll_cta = do_shortcode('[learndash_payment_buttons course_id="' . (int) $course_id . '"]');
        } elseif ( shortcode_exists('learndash_course_info') ) {
          $enroll_cta = do_shortcode('[learndash_course_info course_id="' . (int) $course_id . '"]');
        }
        ?>
      ...
      <div class="<?php echo esc_attr( $locked_class ); ?>">
        ...
        <?php if ( $user_id && ! $has_access && ! empty( $enroll_cta ) ) : ?>
          <div class="mp-course-enroll-cta u-margin-top-m">
            <?php echo $enroll_cta; ?>
          </div>
        <?php endif; ?>
